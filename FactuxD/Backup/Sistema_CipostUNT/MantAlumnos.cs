    ...
    public partial class MantAlumnos : FormMantenimiento
    {
      ...
      /*  public void mRegistraAlumnos(string codigo, string dni, string apellido, string nombre, char genero, char celular)
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            ...
            string Direcion = txtDirecc.Text;
            DateTime fechaNacimineto =DatefechaNac.Value;
            string pais = txtPais.Text;
            string department = txtDepartamento.Text;
            string distrito = txtDistrito.Text;
            string programa = txtCodPrograma.Text;
            try
            {
                registro.RegistrarAlumno(Id, dni, apellidos, nombre, Genero, celular, email,
                    Direcion, fechaNacimineto, pais, department, distrito, programa);
                MessageBox.Show("Se registró la información del Alumno");
                MostrarAlumnos();
                LISAlumnos.Enabled = true;
            } catch (Exception error)
            {
                MessageBox.Show(error.Message);
            }*/
        ...
        {
            /*****codigo invalidado
            if (txtApellidos.Text != "" && txtNombre.Text != "" && txtCodPrograma.Text != "")
            {
                ...
                fechanaci = DatefechaNac.Text;
                email = txtEMail.Text;
                direccion = txtDirecc.Text;
                pais = txtPais.Text;
                departamento = txtDepto.Text;
                distrito = txtDistrito.Text;
                programa = txtCodPrograma.Text;

                cnn = new SqlConnection(conexion);
                cmd = new SqlCommand();
                cmd.CommandType = cmd.CommandType;
                cmd.CommandText = "insert into Alumno(aluCodigo,aluDni,aluApellidos,aluNombres,aluGenero,aluCelular,aluEmail," +
                    "aluDireccion,aluFechaNac,aluPais,Departamento,Distrito,codPrograma)values('" + codigo + "','" + dni + "','" + apellidos + "','" + nombre + "','" + celular + "','" + fechanaci + "','" + email + "','" + direccion + "','" + pais + "','" + departamento + "','" + distrito + "','" + programa + "','" + departamento + "')";
