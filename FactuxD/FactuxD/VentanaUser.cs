...
namespace FactuxD
{
    public partial class VentanaUser : Form
    {
        ...
        private void VentanaUser_Load(object sender, EventArgs e)
        {
            ...
            lblNombUsuario.Text = DS.Tables[0].Rows[0]["nom_usu"].ToString().Trim();
            lblUasuario.Text = DS.Tables[0].Rows[0]["cuenta"].ToString().Trim();
        ...
        {
            MessageBox.Show("Su contraseña  es ...:"   +   txtContraseña.Text);
        }
