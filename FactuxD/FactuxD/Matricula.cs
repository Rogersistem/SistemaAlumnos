...
namespace FactuxD
{
    public partial class Matricula : Form
    {
        ...
        {
            DatGrivwMatricula.Visible = true;
            ...
            if (checConsultarAlumno.Checked == true)
                ...
                DatGrivwMatricula.Visible = false;
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            dataGridViewProgramas.Visible = true;

            SqlDataAdapter dc = new SqlDataAdapter("select * from Programa", cn);
            DataTable TC = new DataTable();
            dc.Fill(TC);
            if (checConsultarPrograma.Checked == true)
                dataGridViewProgramas.DataSource = TC;
            else
                dataGridViewProgramas.Visible = false;
            // DatGrivwMatricula.DataSource = false;
        }
        ...
        {    
            //esto afecta a todos los datos que pertenescan a la tabla patricula para su respectivo mantenimiento
            ...
            txtCodAlumno.Text = DatGrivwMatricula.CurrentRow.Cells[2].Value.ToString();
            txtCodPrograma.Text = DatGrivwMatricula.CurrentRow.Cells[3].Value.ToString();
            txtCodHorario.Text = DatGrivwMatricula.CurrentRow.Cells[4].Value.ToString();
            txtPeriodo.Text = DatGrivwMatricula.CurrentRow.Cells[5].Value.ToString();
            txtFecha.Text = DatGrivwMatricula.CurrentRow.Cells[6].Value.ToString();
        ...
        private void checConsultarCursos_CheckedChanged(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter dc = new SqlDataAdapter("SpMostrarCursos", cn);
            DataTable TC = new DataTable();
            dc.Fill(TC);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Utilidades.Ejecutar(cmd);
                MessageBox.Show("se ha liminado");
                txtCodMatricula.Clear();
                txtTipoMatricula.Clear();
                txtCodAlumno.Clear();
                txtCodPrograma.Clear();
