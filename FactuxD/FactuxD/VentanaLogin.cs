...
namespace FactuxD
{
    public partial class VentanaLogin : Form
    {
        ...
        {
            RecuperarContraseña.Visible = true;
        }
        ...
        private void MostrarUsuario()
        {
            try
            {
                ...
                da = new SqlDataAdapter("SpRecuperarCuenta", con);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.AddWithValue("@idusuario", txtIdUsuario.Text);
                da.Fill(dt);
                datagridviewContraseña.DataSource = dt;
        ...
        {
            MostrarUsuario();
            datagridviewContraseña.Visible = true;
            
        }

        private void lBLcerra_Click(object sender, EventArgs e)
        {
            RecuperarContraseña.Visible = false;
            datagridviewContraseña.DataSource = null;
            datagridviewContraseña.Visible = false;
            txtIdUsuario.Clear();
            txtIdUsuario.Focus();
        }
